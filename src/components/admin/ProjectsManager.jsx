    ...
    const loadProjects = async () => {
        ...
        return snapshot.docs
            .map((d, index) => ({
                ...
                order: d.data().order ?? d.data().created_at?.seconds ?? index,
            }))
    ...
    useEffect(() => {
        (async () => {
            try {
                ...
                const withoutOrder = list.filter((p) => p.order === undefined);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (editingProject) {
                ...
                if (!imageUrl) {
                    setStatus(
                        "Error: Se requiere una imagen para un nuevo proyecto."
                    );
                    return;
                }
